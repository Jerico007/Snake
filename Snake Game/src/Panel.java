    ...
    public void draw(Graphics graphics)
    {
        ...
        if(flag)
        {
            ...
            for(int i = 0 ; i < length ; i++)
            {
                ...
                graphics.fillOval(xsnake[i],ysnake[i], 25,24 );
            }
            ...
            graphics.drawString("Highest score : " + highestscore , ((width-fme.stringWidth("Highest score : " + highestscore))/2) , height/2-120);
